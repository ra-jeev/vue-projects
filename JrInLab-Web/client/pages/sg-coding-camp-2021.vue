              ...
              <v-window id="form" v-model="step">
                <v-window-item :value="1">
                  ...
                  <div class="grey--text text--darken-3 mt-3">
                    Utilize your child's session break with our 4 weeks coding
                    camp for kids. Kids will learn the basics of coding. The
                    camp is completely project based, and will cover all the
                    concepts necessary to complete the projects. We'll be
                    running separate batches for
...
export default {
  ...
  data() {
    return {
      ...
      description: `Keep your child creatively engaged during the session break with our projects based Scratch & Python camps. Separate batches for different age groups.`,
      overlay: false,
      workshopBatches: [
        {
      ...
      benefits: [
        ...
        },
        {
          ...
          description: `These camps are project based, giving a clear idea about what the kids are going to build, and how. They'll create many games & animations utilizing different concepts.`,
        },
        {
          icon: require('~/assets/images/good_team.svg'),
          title: `Batches for Scratch & Python`,
          description: `Separate batches for Scratch and Python. Your child can enrol to more than one batch at the same time (if they are eligible).`,
        },
        {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            'The camp is **4 weeks long** with **12 sessions overall**. All sessions will be conducted on weekdays.',
        },
        {
          question: 'What is your typical batch size?',
          answer:
            'Our batch size is small, usually between 4-5 students. We have found this to be the optimal group size for meaningful collaboration and individual attention.',
        },
        {
          question: 'What is the camp pricing?',
          answer: 'The camp fees is ***S$ 199*** all inclusive.',
        },
        {
          question: 'Any details of the camp activities?',
          answer: `- There will be separate batches for Scratch and Python (Turtle) programming languages. Eligible kids can enrol to both the batches.\n- These camps are completely projects based. Kids will learn to follow a step by step approach to solve a complex problem, by breaking it down into smaller and simpler steps.\n- Kids will also get the exposure to work on different types of problems in different projects.`,
        },
        {
          question: 'What is the outcome of the camp?',
          answer: `- Kids will be able to code cool animations and games using Scratch / Python (Turtle). Visual coding gives children a platform to express their thoughts in an attractive and confident manner.\n- Our camps are structured in a manner that even shy kids open up and express themselves, it will boost their creativity and confidence.`,
        },
        {
