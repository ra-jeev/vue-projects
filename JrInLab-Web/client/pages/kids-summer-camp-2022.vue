          ...
          <v-card class="form-container">
            <v-window id="form" v-model="step">
              <v-window-item :value="1">
                ...
                <div class="form-title mt-8">Camp batches details</div>
                <v-row class="mt-1">
                  <v-col
              ...
              <v-window-item :value="2">
                ...
                <RegisterForm
                  ...
                  mobile-number-hint="No unnecessary calls or marketing messages from us."
                  btn-color="secondary"
                  btn-text="Submit Now"
                  direct-enroll
                  form-page="kids-summer-camp-2022"
...
export default {
  ...
  data() {
    return {
      ...
      imageAlt: 'Image depicting kids on their computers',
      socialImage: require('~/assets/images/us-summer-camp.png'),
      loading: false,
      expand: false,
      step: 1,
      tags: [
      ...
      campDetails: [
        {
          ...
          value: '10 Sessions (Weekdays or Weekends)',
        },
        {
        ...
        },
        {
          ...
          value: '$ 200',
          subValue: '(20% Early bird discount)',
          strikeValue: '$ 250',
          stretch: true,
          isPrice: true,
        },
      ...
      benefits: [
        ...
        },
        {
          ...
          description: `We'll be running separate batches for Scratch, AppLab, WebDev and Python programming. Your child can enrol to more than one camp (if they are eligible).`,
        },
        {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            'The camp will have **10 sessions overall** conducted either on weekdays or weekends as per your preference.',
        },
        {
          question: 'Will there be a trial class?',
          answer:
            "The first session of the camp will be free for all, so that you can see how the camp is conducted. From second session onward we'll have small batches for each camp.",
        },
        {
