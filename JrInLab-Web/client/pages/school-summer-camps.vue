<template>
  <marketing-container>
    ...
    <template #header>
      <h1 class="page-headline">Online Summer Camp for School Kids</h1>
    </template>
    ...
    <template #details>
      ...
      <div class="section bg--lighter">
        <v-container>
          <h2 class="section__header text-center">Glimpses of our camps</h2>
          <card-carousel
            :aspect-ratio="4 / 3"
            :slides="campsMedia"
            :slides-per-screen="2"
      ...
      <div class="section bg--lighter">
        <v-container>
          <h2 class="section__header text-center">
            Some of our students' other creations
          </h2>
          <card-carousel
            :slides="media"
            :slides-per-screen="2"
...
export default {
  ...
  data() {
    return {
      ...
      benefits: [
        {
          icon: require('~/assets/images/project_team.svg'),
          title: `Project based learning`,
          description: `Our camp activities are all project based. This helps the students get a clear picture of what they're going to create, and how.`,
        },
        {
          icon: require('~/assets/images/teacher.svg'),
          title: `Qualified & experienced instructors`,
          description: `Our instructors have been with us for more than 1.5-2 years now. They've a vast experience in teaching kids from different age groups & nationalities.`,
        },
        {
          icon: require('~/assets/images/group_hangout.svg'),
          title: `Experience with online & offline camps`,
          description: `We've been conducting various camps of different sizes, both online & offline, over the years. We know what it takes to conduct a successful camp for schools.`,
        },
      ],
      websites: [
        {
      ...
      title: 'Online Summer Camp 2022 for school students',
      description:
        'Keep you students creatively engaged this summer with introduction to block coding, app development & web development (with live websites).',
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          hid: 'og:url',
          property: 'og:url',
          content: 'https://www.jrinlab.com/school-summer-camps',
        },
        {
          hid: 'twitter:title',
          name: 'twitter:title',
